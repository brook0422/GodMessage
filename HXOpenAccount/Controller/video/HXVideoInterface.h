...
@protocol HXVideoResultVCDelegate <NSObject>
@optional
-(void) OnVideoResultPushVC:(NSDictionary *)dic;//跳转到下一个页面
-(void) OnVideoResultPopVC:(NSDictionary *)dic;//跳转到上一个页面
@end
...
#define LOCALVIDEO_PRESETCTRL   @"3"  //性能均衡、效率优先
#define LOCALVIDEO_QUALITYCTRL  @"3"  //视频质量 普通、中等
